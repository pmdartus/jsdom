...
const { isValidCustomElementName, tryUpgrade,
  ...
  define(name, ctor, options) {
    ...
    if (extendsOption !== null) {
      if (isValidCustomElementName(extendsOption)) {
        throw new DOMException("Option extends value can't be a valid custom element name.");
      }

      // TODO: Add interface lookup
      // If the element interface for extends and the HTML namespace is HTMLUnknownElement (e.g., if extends does not
