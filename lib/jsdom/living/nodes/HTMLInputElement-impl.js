...
class HTMLInputElementImpl extends HTMLElementImpl {
  ...
  set valueAsDate(v) {
    if (!allowValueAsDate(this.type)) {
      throw new DOMException("Failed to set the 'valueAsDate' property on 'HTMLInputElement': This input element does not support Date values.", "InvalidStateError");
    }
  ...
  set valueAsNumber(v) {
    ...
    if (!allowValueAsNumber(this.type)) {
      throw new DOMException("Failed to set the 'valueAsNumber' property on 'HTMLInputElement': This input element does not support Number values.", "InvalidStateError");
    }
  ...
  _stepUpdate(n, isUp) {
    ...
    if (!allowValueAsNumber(this.type)) {
      throw new DOMException(`Failed to invoke '${isUp ? 'stepUp' : 'stepDown' }' method on 'HTMLInputElement': This input element does not support Number values.`, "InvalidStateError");
    }

    const allowedValueStep = this._allowedValueStep;
    if (allowedValueStep === null) {
      throw new DOMException(`Failed to invoke '${isUp ? 'stepUp' : 'stepDown' }' method on 'HTMLInputElement': This input element does not support value step.`, "InvalidStateError");
    }
