...
const {
  isShadowRoot, getRoot, shadowIncludingRoot, shadowDomInclusiveDescendantIterator,
  ...
  _insert(nodeImpl, childImpl) {
    ...
    for (const node of nodesImpl) {
      ...
      if (this._isConnected()) {
        for (const inclusiveDescendant of shadowDomInclusiveDescendantIterator(nodeImpl)) {
