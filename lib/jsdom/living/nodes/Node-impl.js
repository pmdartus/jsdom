...
const { simultaneousIterators, mixin } = require("../../utils");
...
const { CeReactions, CUSTOM_ELEMENT_STATE, enqueueCECallbackReaction,
  tryUpgradeElement } = require("../helpers/custom-elements");
const {
  isShadowRoot, getRoot, shadowIncludingRoot, assignSlot, assignSlotableForTree, assignSlotable,
  signalSlotChange, isSlot, shadowIncludingInclusiveDescendantsIterator, shadowIncludingDescendantsIterator
...
mixin(NodeImpl.prototype, CeReactions.prototype);
