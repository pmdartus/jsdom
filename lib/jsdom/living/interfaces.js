...
const generatedInterfaces = [
  ...
  require("./generated/StyleSheetList")
];
...
exports.installInterfaces = function (window) {
  ...
  install(window, "StyleSheet", cssom.StyleSheet);
  install(window, "MediaList", cssom.MediaList);
  install(window, "CSSStyleSheet", cssom.CSSStyleSheet);
  install(window, "CSSRule", cssom.CSSRule);
  install(window, "CSSStyleRule", cssom.CSSStyleRule);
  install(window, "CSSMediaRule", cssom.CSSMediaRule);
  install(window, "CSSImportRule", cssom.CSSImportRule);
  install(window, "CSSStyleDeclaration", cssstyle.CSSStyleDeclaration);
