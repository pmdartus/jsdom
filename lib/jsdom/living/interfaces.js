...
const { ctorRegistrySymbol } = require("./generated/utils");
...
/** Returns an interface constructor attach a global object object given an interface name. */
exports.getInterfaceConstructor = function (window, name) {
  return window[ctorRegistrySymbol][name];
};
