...
const { patchHTMLConstructor } = require("../living/helpers/html-element-constructor");
...
function Window(options) {
  ...
  // TODO: It should not be an impl but a wrapper instead.
  // This need to be refactored and attached maybe on another object.
  this.customElements = CustomElementRegistry.createImpl([], {
