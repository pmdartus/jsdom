...
class Parse5Adapter {
  ...
  createElement(localName, namespace, attrs) {
    ...
    // TODO:  If will execute script is true, set the synchronous custom elements flag; otherwise, leave it unset.
    const element = createElement(this._documentImpl, localName, namespace, null, isValue, true);
